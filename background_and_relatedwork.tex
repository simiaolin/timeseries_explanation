...
These include distance measurement methods, averaging methods and semi-supervised clustering methods in perspective of time series. 
...
Before diving into the details of DTW algorithm, we would like to first introduce some premises of DTW. 
\begin{itemize}
