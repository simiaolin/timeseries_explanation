...
\begin{figure}[htbp]
	...
	\begin{minipage}[t]{0.48\textwidth}
		...
		\caption{Arithmetic mean \cite{dta_vs_arithmeticmean}}
		\label{fig:arithmetic}
	\end{minipage}
	\begin{minipage}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=\linewidth]{pics/related_work/DBA}
		\caption{DBA \cite{dta_vs_arithmeticmean}}
		\label{fig:dba}
	\end{minipage}
\end{figure}
