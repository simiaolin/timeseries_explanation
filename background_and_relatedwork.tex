...
In supervised learning, we have the labels of all the instances. It enjoys the clarity of data and is easy to train. However, labeling all the data is not a trivial task, and sometimes it is not easy or even impossible to get the labels of data.
