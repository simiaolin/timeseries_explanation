...
Finally, combine all the must-links and cannot-link found above, we have constraint chain $\mathit{a-I_1-I_2-I_3-I_4-I_5-c}$, where except for $\mathit{I_3-I_4}$ all the constraints are must-links.
\begin{figure}[htbp]	
	\centering
