...
At around 40 on the time axis, the horizontal warping deviation is large, so there is a lot of variation in the time axis for this part. This indicates that the transition around the time of 40 can occur at dfferent times in this cluster. On the other hand, the vertical warping deviation is small, so the amplitude does not change significantly.
