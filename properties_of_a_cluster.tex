...
\begin{enumerate} 
	...
	We also compute the traditional unwarping deviation, but it is not shown in \cref{fig:properties_process} because it is relatively irrelevant. We still compute it as we want to compare the vertical warping deviation to see the difference.
